<?php
/**
 * ALKALMAZOTTAK ÉRTESÍTÉS DOKUMENTUMOKHOZ MEGJELENÍTÉSE
 */
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="nav navbar-nav ml-auto">
        <li class="nav-item <?php active_page('notifications_email.php'); ?>">
...
<div class="">
    <h2>Alkalmazottak értesítése e-mailben: </h2>
</div>
...
<div class="form">
    ...
    <?php
    /**
     * E-MAIL KÜLDÉS ESETÉN MEGJELENITETT ÉRTESÍTÉSEK
     */
    if (isset($_SESSION['email_sent'])) {
        ...
        } else if ($_SESSION['email_sent'] === "FALSE") {
            ?>
            <div class="alert alert-warning alert-dismissible fade show">
                <button type="button" class="close" style="box-shadow: none; width: 100px;" data-dismiss="alert">
                    &times;
                </button>
                <strong>Hiba történt - nem sikerült elküldeni az emailt!</strong>
            </div>
            <?php
        }
    };
    ...
    <div class="input-group mb-3" style="max-width: 650px">
        ...
        <select class="custom-select" id="color">
            ...
            <option value="SENT" class="table-secondary">Értesítés kiküldve</option>
            <option value="NEW" class="table-warning">Hamarosan lejár</option>
...
<script>
    ...
    /**
     * ADATOK BEOLVASÁSA AJAX POST SEGÍTSÉGÉVEL A - NOTIFICATIONS_EMAILTABLEACTION.PHP -BÓL
     */
    function readRecords() {
        ...
        var color = $('#color').val();
        $.ajax({
            url: "notifications_emailtableaction.php",
            type: "POST",
