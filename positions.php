<?php
/**
 * POZÍCIÓK MEGJELENÍTÉSE TÁBLÁZAT
 */
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="nav navbar-nav ml-auto">
        <li class="nav-item <?php active_page('positions.php'); ?>">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    <li>A kiválasztott pozíció</li>
                    <li>Ezen pozícióhoz rendelt dokumentumok</li>
                    <li>Esetlegesen ezen dokumentumokhoz tartozó értesítések</li>
                    <li>Alkalmazottak ezen pozícióhoz tartozó dokumentum bejegyzései</li>
                    <li>Alkalmazottak pozíció bejegyzésének törlése, amelyek ebben a pozícióban vannak alkalmazva</li>
                </ul>
            </div>
            <div class="modal-footer">
                <button type="submit" onclick="deletePosition(this.value)" id="deleteID"
...
<script>
    ...
    /**
     * ADATOK BEOLVASÁSA AJAX POST SEGÍTSÉGÉVEL A - POSITIONSTABLEACTION.PHP -BÓL
     */
